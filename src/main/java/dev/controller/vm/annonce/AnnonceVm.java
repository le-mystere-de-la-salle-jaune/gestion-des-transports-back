...
public class AnnonceVm {
	...
	public String toString() {
		return vehiculeAnnonce.getMarque() + " " + horraireAnnonce.getDateDepart() + " "
				+ itineraireAnnonce.getAdresseDep();
	}
	...
	public Annonce toAnnonce() {
		...
		annonceToReturn.setVehiculeCovoitureur(vehiculeAnnonce.toVehicule());
